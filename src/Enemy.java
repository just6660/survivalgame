...
public class Enemy {
    ...
    private Rectangle hitbox, attackcdbox, hpbox, redhp;
    ...
    public Enemy(int x, int y) throws SlickException {
        ...
        attackcdbox = new Rectangle((int) hitbox.getX(), (int) hitbox.getY() + imgheight, imgwidth, 10);
        hpbox = new Rectangle((int) hitbox.getX() + 10, (int) hitbox.getY() - 10, imgwidth * health / maxhealth, 10);
        redhp = new Rectangle((int) hitbox.getX() + 10, (int) hitbox.getY() - 10, imgwidth, 10);
    ...
    public Rectangle getAttackCDBox() {
        return attackcdbox;
    }
    public Rectangle getHPBox(){
        return hpbox;
    }
    public Rectangle getRedHpBox(){
        return redhp;
    }
    ...
    public void move(float x, float y, ArrayList<Rectangle>walls) {
        
        int a = (int) hitbox.getX();
        int b = (int) hitbox.getY();
        int origx = a, origy = b;
    ...
    public void draw(int i, int x, int z) {
        if (i == 1) {
            ...
            attackcdbox = new Rectangle((int) hitbox.getX() + 30, (int) hitbox.getY() + imgheight, 5, 5);
            hpbox = new Rectangle((int) hitbox.getX() + 10, (int) hitbox.getY() - 10, imgwidth * health / maxhealth, 10);
            redhp = new Rectangle((int) hitbox.getX() + 10, (int) hitbox.getY() - 10, imgwidth, 10);
