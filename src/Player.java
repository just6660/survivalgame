...
public class Player {
    ...
    private Rectangle hitbox, attackhitbox, attackcdbox, hpbox, redhp;
    ...
    public Player() throws SlickException {
        ...
        hpbox = new Rectangle((int) hitbox.getX() + 10, (int) hitbox.getY() - 10, imgwidth * health / 500, 10);
    ...
    public void move(int i, ArrayList<Rectangle> walls) {
